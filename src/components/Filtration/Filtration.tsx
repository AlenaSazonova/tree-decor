...
interface FiltrationProps {
    onShapeFilter: (type: string) => void;
    onColorFilter: (color: string) => void;
    onSizeFilter: (label: string) => void;
    onAmountFilter: (amount: number) => void;
    onYearFilter: (year: number) => void;
    onNameFilter: (event: React.ChangeEvent<HTMLSelectElement>) => void;
    onFavoriteFilter: (checked: boolean) => void;
    onResetFilters: () => void;
    selectedSize: string[];
...
const Filtration: React.FC<FiltrationProps> = ({ onShapeFilter, onColorFilter, onSizeFilter, onAmountFilter, onYearFilter, currentAmount, currentYear, onNameFilter, onFavoriteFilter, onResetFilters, selectedSize, isFavoriteChecked }) => {
    const shapeFilter = initialState.filter?.shape || [];
    const colorFilter = initialState.filter?.colors || [];
    const sizeFilter = initialState.filter?.size || [];
