...
export const initialState = {
    ...
    bauble: [
        ...
        { src: bauble7, name: 'Молочно-белый шар', amount: 'Количество: 12', yearOfPurchase: 'Год покупки: 1960', type: 'Форма: шар', color: 'Цвет: белый', size: 'Размер: средний', favorite: 'Любимая: нет' },
